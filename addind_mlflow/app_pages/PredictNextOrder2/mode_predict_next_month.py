...
class ModePredictNext(RunMode):
    def __init__(self) -> None:
        super().__init__('Predict next')
    ...
    def run(self, do_update):
        if do_update:
            retrain(TrainConfig(fix_start_month=False, train_month_count=st.session_state[train_month_count]))
